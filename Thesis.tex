...
\abstract{
\addtocontents{toc}{\vspace{1em}}  % Add a gap in the Contents, for aesthetics
The main objective of this study is to evaluate new GOCE missions on Sudan. We have evaluated 5 models; EGM2008, EIGEN-6C4, GECO, ITU\_GGC16, and ITU\_GRACE16. We have compared our evaluation results with two published works \citep{ahmed_msc, godah}. Without any corrections, we reported an accuracy that is comparable to \citep{ahmed_msc, godah}. The best model ITU\_GGC16 with std of $0.365349m$ which is comparable to $0.29m$ and$0.306m$ reported by \cite{ahmed_msc, godah} respectively. Their results without applying any corrections, that is, a geoid height solely derived from GGM were $0.576m$, $0.644m$. Thus, a new datum for Sudan using our proposed models with an accuracy of $0.10m~0.20m$ is quite achievable. For our computations we developed GeoidApp. While it is a generic software for geopotential functionals computations, it is very useful in automating the process of choosing the best model.
}
