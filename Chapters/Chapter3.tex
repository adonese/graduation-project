...
\end{enumerate}
 ...
 \cite{rummel} in their work reported that there are two problems in efficiently model the Earth using satellite observations. In particular they report that 1) satellites can be tracked from the ground only over short intervals
 ...
 \begin{enumerate}
	\item ITU\_GGC16 \citep{ituggc16}. It was released on 2016 with degree and order up-to 280.
